...
These match the names already in `ios/Niyora.storekit`, so what you see while
...
`ios/Niyora.storekit` already contains both products, both prices, and the 7 day
