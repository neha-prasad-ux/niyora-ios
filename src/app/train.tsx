...
import { CHAPTERS, type Chapter } from '@/v3/game-content';
...
// One emotion's card: its colour field, the current level's own pattern on top,
// a progress tag, the emotion name, and a one-line blurb. Whole-card tap opens
// the chapter (resuming at her first incomplete level).
