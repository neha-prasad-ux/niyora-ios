...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: pageGutter, paddingTop: spacing.md, paddingBottom: 60 },
  scrollBtn: { marginTop: spacing.xl },
  // A question laid out like Level 1: statement centred in the space, answers as
  // big cards anchored at the bottom.
  qCenter: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.xxl, gap: spacing.md },
  qStatement: {
  ...
  chipText: { fontFamily: fonts.regular, fontSize: fontScale.caption, color: colors.textOnDark.secondary },
  chipTextOn: { fontFamily: fonts.medium, color: colors.textOnDark.primary },
  sliderArea: { height: 44, justifyContent: 'center' },
  sliderTrack: { height: 4, borderRadius: 2, backgroundColor: colors.fill.strong },
  sliderFill: {
    position: 'absolute',
    top: 20,
    left: 0,
  ...
  sliderEnd: { fontFamily: fonts.regular, fontSize: fontScale.tagline, color: colors.textOnDark.faint },
  sliderValue: { fontFamily: fonts.medium, fontSize: fontScale.caption, color: colors.textOnDark.primary },
  domainRow: { marginBottom: spacing.xl },
  domainHead: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  domainLabel: { fontFamily: fonts.medium, fontSize: fontScale.body, color: colors.textPrimary },
  muteLink: { fontFamily: fonts.regular, fontSize: fontScale.caption, color: colors.textOnDark.faint },
  mutedNote: {
    fontFamily: fonts.regular,
    fontSize: fontScale.caption,
    color: colors.textOnDark.faint,
  ...
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.xxxl, gap: spacing.xl },
  emptyText: {
    fontFamily: fonts.regular,
  ...
  primaryBtnText: { fontFamily: fonts.medium, fontSize: fontScale.body, color: colors.textOnDark.primary },
});
